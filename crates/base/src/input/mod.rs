...
pub use decorations::{
    GutterLane, GutterLaneOptions, GutterLaneView, GutterMarker, GutterMarkerRenderer, InlineWidget,
    InlineWidgetCollection, RangeDecoration, RangeDecorationCollection, RangeDecorationStyle,
