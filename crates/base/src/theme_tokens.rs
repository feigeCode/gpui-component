...
use gpui::{
    BoxShadow, ColorExt as _, FontWeight, Hsla, Pixels, SharedString, hsla, point, px, rgb,
    rgb_to_hsla,
};
...
impl ColorTokens {
    ...
    pub fn light() -> Self {
        Self {
            ...
            selection: rgb_to_hsla(rgb(0x55a0fc)).opacity(0.3),
        }
    }
    ...
    pub fn dark() -> Self {
        Self {
            ...
            selection: rgb_to_hsla(rgb(0x1d4ed8)).opacity(0.3),
        }
    }
